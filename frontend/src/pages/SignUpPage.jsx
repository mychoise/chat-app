...
const SignUpPage = () => {
  ...
  return (
    <div className=' mt-6 h-[96vh]  overflow-y-hidden'>
       <div className="min-h-screen overflow-y-hidden grid lg:grid-cols-2">
      {/* left side */}
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 z-10 pl-3 flex items-center pointer-events-none">
                  <User className="size-5 absolute  text-base-content/40" />
                </div>
                <input
                  type="text"
